 ...
 * 		doGet() -> GET 방식 요청을 처리. doPost() -> POST방식 요청을 처리.
 * 		
...
public class HelloServlet extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException{
		...
		String current = String.format("%tY-%<tm-%<td %<tH:%<tM:%<tS", date);
							//String으로 형변환 시켜주는 format 사용(JDK1.5부터)
		
		//SimpleDateFormat : java.util.Date --> String(fomat()), String-->Date(parse())
		//yyyy : 년도(4자리) MM : 월(2) dd : 일(2) HH : 시간(24시간-2자리0) mm : 분(2) ss : 초(2)
